...
- [rnd.next](https://github.com/tonlabs/TON-Solidity-Compiler/blob/master/API.md#rndnext) now returns correct random number. Use `rnd.shuffle()` before `rnd.next()` on TonOS Se
- Fixed compilation errors `UInt256::from`
